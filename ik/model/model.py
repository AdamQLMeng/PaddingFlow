...
from model.config import SIGMOID_SCALING_ABS_MAX
from utils.utils import assert_joint_angle_tensor_in_joint_limits
...
class IkflowModelParameters:
    def __init__(self):
        ...
        self.softflow_noise_scale = 0.001
        self.softflow_enabled = True
        self.noise_type = "soft"
